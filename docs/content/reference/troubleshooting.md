...
Most of these come down to network reality or how rcsb serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rcsb rate-limits like any public site. rcsb already paces
...
Where a surface is gated, rcsb reads a cookie or token you supply
...
`rcsb`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rcsb actually did
